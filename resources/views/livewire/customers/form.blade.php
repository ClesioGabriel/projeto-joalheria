        ...
        <div style="max-height:80vh; overflow:auto; padding:1.25rem;">
            ...
            <form wire:submit.prevent="save" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" wire:model.defer="cpf" class="w-full border rounded px-3 py-2 focus:ring focus:ring-blue-200">
                ...
                {{-- debug: mostra a resposta bruta do viaCEP quando presente --}}
