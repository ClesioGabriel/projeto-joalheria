<div> 
    ...
    @if ($showViewModal)
        <div class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
            <div class="p-8 max-w-2xl mx-auto bg-white rounded-2xl shadow-lg border border-gray-200 text-left relative z-50" wire:click.stop>
                ...
                <div class="space-y-4 text-gray-700">
                    ...
                    <div><span class="font-semibold text-gray-900">🧾 CPF:</span> {{ $customer->cpf ?? 'Não informado' }}</div>
